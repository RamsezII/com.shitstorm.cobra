...
namespace _COBRA_
{
    partial class Command
    {
        public partial class Executor : IDisposable
        {
            ...
            internal Executor(in Shell shell, in Executor parent, in Line line, in List<Command> path)
            {
                instances.Add(this);
                ...
                if (error == null)
                    if (line.TryReadCommandSeparator(out string spr, is_pipe: command.on_pipe != null))
                    {
                        bool
