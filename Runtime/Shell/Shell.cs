    ...
    public sealed partial class Shell : MonoBehaviour
    {
        ...
        internal static string Monitor()
        {
            ...
            void LogExe(in Command.Executor exe) =>
                sb.AppendLine($" {exe.shell.SID,5} {exe.PEID,5} {exe.EID,5} {exe.cmd_longname,35} {exe.routine?.Current.state ?? CMD_STATES.BLOCKING,15} {exe.background,15} {exe.disposed,15}");
